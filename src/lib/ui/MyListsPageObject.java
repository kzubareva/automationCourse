...
public class MyListsPageObject extends MainPageObject{
    ...
    public static final String
            ...
            SAVED_ARTICLES_LIST = "//*[@resource-id = 'org.wikipedia:id/page_list_item_container']";
    ...
    {
        String article_xpath = getSavedArticleXpathByTitle(article_title);
        this.waitForElementNotPresent(By.xpath(article_xpath),"Saved article is still here with title"  + article_title,15);
    }
    ...
    public int amountOfLostArticles()
    {
     return this.getAmountOfElements(By.xpath(SAVED_ARTICLES_LIST));
    }
}
